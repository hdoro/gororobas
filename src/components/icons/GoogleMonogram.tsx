...
export default function GoogleMonogram({
	variant = 'color',
	...props
	...
	return (
		<svg width="0.98em" height="auto" viewBox="0 0 256 262" {...props}>
			...
			/>
			<path
				fill={variant === 'color' ? '#FBBC05' : 'currentColor'}
			...
			/>
			<path
				fill={variant === 'color' ? '#34A853' : 'currentColor'}
				opacity={variant === 'monochrome' ? 0.5 : undefined}
				d="M130.55 261.1c35.248 0 64.839-11.605 86.453-31.622l-41.196-31.913c-11.024 7.688-25.82 13.055-45.257 13.055c-34.523 0-63.824-22.773-74.269-54.25l-1.531.13l-40.298 31.187l-.527 1.465C35.393 231.798 79.49 261.1 130.55 261.1"
			/>
			<path
				fill={variant === 'color' ? '#4285F4' : 'currentColor'}
				opacity={variant === 'monochrome' ? 0.35 : undefined}
